...
public class Constant {
    ...
    /**
     * DependencyPass needed resources
     */
    //public static String DEPENDENCY_DIR = Utils.join(RES_DIR, "MyPass");
    //public static String PASS_DIR = Utils.join(RES_DIR, "MyPass");
    public static String DEPENDENCY_DIR = "";
    public static String PASS_DIR = "";
    /**
