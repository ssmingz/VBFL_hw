...
//        }
    ...
    public static void writeStringToFile(String content, File file) {
        if(file == null) {
            System.out.println("#writeStringToFile Illegal arguments (file) : null");
        }
        if(content == null) {
            System.out.println("#writeStringToFile Illegal arguments (content) : null");
        }
        if(!file.exists()) {
            try {
                ...
                System.out.println("#writeStringToFile Create new file failed : " + file.getAbsolutePath());
            }
        }
