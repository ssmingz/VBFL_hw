...
public class IntraGenTreeDemo {
    ...
    private static DependencyParser2 dependencyParser = null;
    ...
    public static void main(String[] args) {
        ...
        DEPENDENCY_FILE_PATH = "/mnt/values/1.txt"; //args[2];
