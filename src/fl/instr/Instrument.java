...
*/
    ...
    public static void instrumentTestMethod(File testFile, Set<String> testMethods, String projectPath) {
        ...
        if(testFile.getAbsolutePath().contains("TypeResolverTest")){
    ...
    private static class SuperClazzTestMethodVisitor extends ASTVisitor {
        ...
        public boolean visit(TypeDeclaration node) {
            ...
            Instrument.instrumentSuperClazzTestMethod(superFile, _methodNames, _projectPath); // _uncheckedMethods will change, but no need to return MethodDecl since already instrument at superclass
            return true;
