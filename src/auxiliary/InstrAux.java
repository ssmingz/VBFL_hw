...
public class InstrAux {
     ...
     */
    public static void collectElements(  Collection target,  String name,  int lineNo, int colNo, int level){
        if (target == null) {
            return;
        }
     ...
     */
    public static void collectElements(  Map target,  String name,  int lineNo, int colNo, int level){
        if (target == null) {
            return;
        }
        ...
        if (target.size() > 10 && itr.hasNext() && level<=3) {
            ...
            if(obj != null) {
                ...
                elementRecursion(obj,name+"{PRED}.keys["+index+"]", lineNo, colNo, level+1);
     ...
     */
    public static void collectElements(  Object[] target,  String name,  int lineNo, int colNo, int level){
        updateRecorder(name + "{PRED}.length-" + lineNo + "/" + colNo, ""+target.length);
        for (int ii=0; ii < target.length && ii < 10 && level<=3; ii++) {
            checkNull(target[ii], name+"{PRED}["+ii+"]", lineNo, colNo);
            if(target[ii] != null) {
                elementRecursion(target[ii],name + "{PRED}[" + ii+ "]", lineNo, colNo, level+1);
    ...
    public static Object getValue(  Object obj,  String name,  int lineNo, int colNo){
        ...
        if (isArray) {
            ...
            if (componentType.equals("int")) {
                ...
                collectElements((Object[])obj,name,lineNo,colNo,0);
            }
            return obj;
        }
        else if (isCollection) {
            collectElements((Collection)obj,name,lineNo,colNo,0);
            return obj;
        }
        else if (isMap) {
            collectElements((Map)obj,name,lineNo,colNo,0);
            return obj;
        }
    ...
    public static void collectElements(  Collection target,  String name,  int lineNo, int colNo, int size, int level){
        if (target == null) {
            return;
        }
        Iterator itr=target.iterator();
        ...
        if (target.size() > 10 && itr.hasNext() && level<=3) {
            ...
            if(obj != null) {
                ...
                elementRecursion(obj,name+"{PRED}["+index+"]", lineNo, colNo, size, level+1);
     ...
     * traverse element for Map object only output keys directly in toString() style rather than in object style output type of keys also collect length ignore values
     */
    public static void collectElements(  Map target,  String name,  int lineNo, int colNo, int size, int level){
        if (target == null) {
            return;
        }
        Iterator itr=target.keySet().iterator();
        ...
        if (target.size() > 10 && itr.hasNext() && level<=3) {
            ...
            if(obj != null) {
                ...
                elementRecursion(obj,name+"{PRED}.keys["+index+"]", lineNo, colNo, size, level+1);
     ...
     * traverse element for array also collect length
     */
    public static void collectElements(  Object[] target,  String name,  int lineNo, int colNo, int size, int level){
        updateRecorder(name + "{PRED}.length-" + lineNo + "/" + colNo + "/" + size, ""+target.length);
        for (int ii=0; ii < target.length && ii < 10 && level<=3; ii++) {
            checkNull(target[ii], name+"{PRED}["+ii+"]", lineNo, colNo, size);
            if(target[ii] != null) {
                elementRecursion(target[ii], name+"{PRED}["+ii+"]", lineNo, colNo, size, level+1);
    ...
    public static void elementRecursion(Object obj, String name, int lineNo, int colNo, int level) {
        Class clazz=obj.getClass();
        boolean isCollection=Collection.class.isAssignableFrom(clazz);
        boolean isArray=clazz.isArray();
        boolean isMap=Map.class.isAssignableFrom(clazz);
        if (isArray) {
            ...
            if (componentType.equals("int")) {
                ...
                collectElements((Object[])obj,name,lineNo,colNo,level);
            }
        }
        else if (isCollection) {
            collectElements((Collection)obj,name,lineNo,colNo,level);
        }
        else if (isMap) {
            collectElements((Map)obj,name,lineNo,colNo,level);
        }
    }
    public static void elementRecursion(Object obj, String name, int lineNo, int colNo, int size, int level) {
        Class clazz=obj.getClass();
        boolean isCollection=Collection.class.isAssignableFrom(clazz);
        boolean isArray=clazz.isArray();
        boolean isMap=Map.class.isAssignableFrom(clazz);
        if (isArray) {
            ...
            if (componentType.equals("int")) {
                ...
                collectElements((Object[])obj,name,lineNo,colNo,size,level);
            }
        }
        else if (isCollection) {
            collectElements((Collection)obj,name,lineNo,colNo,size,level);
        }
        else if (isMap) {
            collectElements((Map)obj,name,lineNo,colNo,size,level);
        }
    }
}
